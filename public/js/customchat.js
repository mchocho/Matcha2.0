$(function () {
	...
	var chatID = '/' + window.location.href.substring(window.location.href.lastIndexOf('/') + 1);
	...
	socket.on('chat message', function (msg) {
		$chat.append('<li class="list-group-item">' + '<span><b>' + msg.nick + ': </b></span>' + msg.msg);
		// $chat.append($('<li class="list-group-item">').text(msg));
	});

	socket.on('whisper', function (msg) {
		$chat.append('<li class="whisper list-group-item">' + '<span><b>' + msg.nick + ': </b></span>' + msg.msg);
	});
