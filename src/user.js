...
//Remainder of routes respond with JSON text
...
router.post("/biography", (req, res) =>
{
	...
	{
		if (value.length > 3500) //500 less than character limit
		{
	...
	function saveNewBio()
	{
		dbc.query(sql.updateUserBio, [value, sess.id], (err, result) =>
		{
			if (err) {throw err}
